!(function (t) {
  ...
  (l.nextTick = function (t) {
    ...
    y.push(new w(t, e)), 1 !== y.length || d || p(g);
  }),
  ...
  (function (t, r, a) {
        ...
        function (r) {
          ...
          l
            ? ((g = a + "/"),
              ...
              1 < t.argv.length && (f = t.argv[1].replace(/\\/g, "/")),
              t.argv.slice(2),
              t.on("uncaughtException", function (t) {
                throw t;
              }),
          ...
          var w,
            b = o.print || console.log.bind(console),
            E = o.printErr || console.warn.bind(console);
          ...
          function gt(t, e, n) {
            function r(e) {
              ...
              for (var r = 0; r < t.length; ++r) wt(t[r], e[r]);
            }
          ...
          function Tt(t) {
            --t.count.value,
              0 === t.count.value && (t.ka ? t.la.pa(t.ka) : t.ha.fa.pa(t.ga));
          }
          function At(t) {
            return "undefined" == typeof FinalizationGroup
              ? ((At = function (t) {
                ...
                t)
              : ((Ct = new FinalizationGroup(function (t) {
          ...
          function Mt(t, e) {
            if (null === e) {
              if (
                ...
                var n = this.Ra();
                return null !== t && t.push(this.pa, n), n;
              }
              return 0;
            }
            if (
          ...
          function Xt(t, e, n, r, a) {
            ...
            return (
              ...
              (function (t) {
                ...
                var n = pt(e.name || "unknownFunctionName", function () {});
                return (
          ...
          function Qt(t) {
            4 < t && 0 == --Kt[t].Ea && ((Kt[t] = void 0), Zt.push(t));
          }
          function $t(t) {
            switch (t) {
              case void 0:
          ...
          function pe(t, e) {
            for (t = new Date(t.getTime()); 0 < e; ) {
              var n = t.getMonth(),
                r = (ce(t.getFullYear()) ? se : fe)[n];
              if (!(e > r - t.getDate())) {
          ...
          for (var he = Array(256), ye = 0; 256 > ye; ++ye)
          ...
          var de = {
              ...
              g: function (t, e, n, r, a, i, o, u, c, l, s, f, p) {
                (s = ut(s)),
                  (i = Bt(a, i)),
                  u && (u = Bt(o, u)),
                  l && (l = Bt(c, l)),
                ...
                St(h, function () {
                  ...
                  gt([t, e, n], r ? [r] : [], function (e) {
                    ...
                    (n = new Yt(s, c, !0, !1)),
                      (a = new Yt(s + "*", c, !1, !1));
                    var f = new Yt(s + " const*", c, !1, !0);
                    return (
                      (Pt[t] = { pointerType: a, Ha: f }), Ht(h, e), [n, a, f]
                    );
                  });
              },
              f: function (t, e, n, r, a, i) {
                var o = qt(e, n);
                a = Bt(r, a);
                var u = [i],
                  c = [];
              ...
              e: function (t, e, n, r, a) {
                ...
                wt(t, {
                  ...
                  argPackAdvance: 8,
                  readValueFromPointer: ae(e, o, 0 !== r),
                  na: null,
                });
              },
              d: function (t, e, n) {
                ...
                wt(t, {
                  ...
                  toWireType: function (t, n) {
                    var i = n.length,
                      ...
                      u = r();
                    M[o >> 2] = i;
                    for (var c = (o + 4) >> a, l = 0; l < i; ++l)
                      u[c + l] = n.charCodeAt(l);
                    return null !== t && t.push(be, o), o;
                  },
                  argPackAdvance: 8,
                  readValueFromPointer: Rt,
                  na: function (t) {
              ...
              x: function (t, e, n, r) {
                return (function (t, e, n, r) {
                  ...
                  function c(t) {
                    ...
                    var e = u(new Date(t.getFullYear() + 1, 0, 4));
                    return 0 >= o(u(new Date(t.getFullYear(), 0, 4)), t)
                      ? 0 >= o(e, t)
                        ? t.getFullYear() + 1
                        : t.getFullYear()
                      : t.getFullYear() - 1;
                  ...
                  for (s in (l = {
                    ...
                    "%U": function (t) {
                      var e = new Date(t.ja + 1900, 0, 1),
                        n = 0 === e.getDay() ? e : pe(e, 7 - e.getDay());
                      return 0 > o(n, (t = new Date(t.ja + 1900, t.sa, t.ua)))
                        ? i(
                            Math.ceil(
                              (31 -
                                n.getDate() +
                    ...
                    "%V": function (t) {
                      var e = u(new Date(t.ja + 1900, 0, 4)),
                        n = u(new Date(t.ja + 1901, 0, 4)),
                        r = pe(new Date(t.ja + 1900, 0, 1), t.Ba);
                      return 0 > o(r, e)
                        ? "53"
                        : 0 >= o(n, r)
                        ? "01"
                    ...
                    "%W": function (t) {
                      var e = new Date(t.ja, 0, 1),
                        n =
                          1 === e.getDay()
                            ? e
                            : pe(e, 0 === e.getDay() ? 1 : 7 - e.getDay() + 1);
                      return 0 > o(n, (t = new Date(t.ja + 1900, t.sa, t.ua)))
                        ? i(
                            Math.ceil(
                              (31 -
    ...
    "object" == typeof E.exports
      ? (E.exports = o)
      : "object" == typeof E.exports && (E.exports.anitomyscript = o);
  }.call(this, c, "/build/anitomyscript.js", "/build"),
    (E = E.exports));
  var C,
    _ = (C = u) && C.__esModule ? C : { default: C };
